...
const FLOWER_SPRITE_ANCHOR_X = 0.6149
const FLOWER_SPRITE_ANCHOR_Y = 0.2966
const FLOWER_SPRITE_ASPECT = 879 / 1239
...
function drawFlower(
  ...
  const breezeX = reducedMotion ? 0 : Math.sin(time * 0.0014 + flower.seed * 8.9) * unit * 2.3
  const breezeY = reducedMotion ? 0 : Math.sin(time * 0.001 + flower.seed * 4.7) * unit * 0.35
